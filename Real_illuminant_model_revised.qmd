...
```{r}
mr1.side.sex <- lmer(h.theta_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.side)
mr1.maxi.sex <- lmer(h.theta_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.maxi)
mr1.mand.sex <- lmer(h.theta_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.mand)
mr1.pala.sex <- lmer(h.theta_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.pala)

class(mr1.side.sex) <- "lmerMod"
class(mr1.maxi.sex) <- "lmerMod"
class(mr1.mand.sex) <- "lmerMod" 
class(mr1.pala.sex) <- "lmerMod"


h.theta_s.sum.sex <- stargazer(mr1.side.sex, mr1.maxi.sex, mr1.mand.sex, mr1.pala.sex, digits = 2, type = "text", style = "default", title = "h.theta_s Mixed models (Estimate + (Std. Error)", column.labels = c("Flanges", "Maxilla", "Mandible", "Palate"))
...
h.theta_s.sum <- stargazer(mr1.side, mr1.maxi, mr1.mand, mr1.pala, digits = 2, type = "text", style = "default", title = "h.theta_s Mixed models (Estimate + (Std. Error)", column.labels = c("Flanges", "Maxilla", "Mandible", "Palate"))
...
```{r}
#| echo: false
modelsummary(list(mr1.side, mr1.maxi, mr1.mand, mr1.pala), 
             statistic = NULL, 
...
rsidetheta <- ggplot(plot.mr1.side, aes(x = TypeAge, y = the.emmean, ymin =  lower.CL, ymax = upper.CL, color = group))  +
  ...
  theme(legend.position = "none") + ylab ("Hue") + xlab("Group")  +
...
```{r}
mr2.side.sex <- lmer(h.phi_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.side)
mr2.maxi.sex <- lmer(h.phi_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.maxi)
mr2.mand.sex <- lmer(h.phi_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.mand)
mr2.pala.sex <- lmer(h.phi_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.pala)

class(mr2.side.sex) <- "lmerMod"
class(mr2.maxi.sex) <- "lmerMod"
class(mr2.mand.sex) <- "lmerMod"
class(mr2.pala.sex) <- "lmerMod"

h.phi_s.real.sum.sex <- stargazer(mr2.side.sex, mr2.maxi.sex, mr2.mand.sex, mr2.pala.sex, digits = 2, type = "text", style = "default", title = "h.phi_s Mixed models (Estimate + (Std. Error)", column.labels = c("Side", "Maxilla", "Mandible", "Palate"))
```
...
h.phi_s.real.sum <- stargazer(mr2.side, mr2.maxi, mr2.mand, mr2.pala, digits = 2, type = "text", style = "default", title = "h.phi_s Mixed models (Estimate + (Std. Error)", column.labels = c("Flanges", "Maxilla", "Mandible", "Palate"))
```
...
```{r}
mr3.side.sex <- lmer( r.achieved_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.side)
mr3.maxi.sex <- lmer( r.achieved_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.maxi)
mr3.mand.sex <- lmer( r.achieved_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.mand)
mr3.pala.sex <- lmer( r.achieved_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.pala)

class(mr3.side.sex) <- "lmerMod"
class(mr3.maxi.sex) <- "lmerMod"
class(mr3.mand.sex) <- "lmerMod"
class(mr3.pala.sex) <- "lmerMod"

r.achieved_s.sum.sex <- stargazer(mr3.side.sex, mr3.maxi.sex, mr3.mand.sex, mr3.pala.sex, digits = 2, type = "text", style = "default", title = " r.achieved_s Mixed models (Estimate + (Std. Error)", column.labels = c("Flanges", "Maxilla", "Mandible", "Palate"))
```
...
```{r}
mr4.side.sex <- lmer(lum_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.side)
mr4.maxi.sex <- lmer(lum_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.maxi)
mr4.mand.sex <- lmer(lum_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.mand)
mr4.pala.sex <- lmer(lum_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.pala)

class(mr4.side.sex) <- "lmerMod"
class(mr4.maxi.sex) <- "lmerMod"
class(mr4.mand.sex) <- "lmerMod"
class(mr4.pala.sex) <- "lmerMod"

lum_s.sum.sex <- stargazer(mr4.side.sex, mr4.maxi.sex, mr4.mand.sex, mr4.pala.sex, digits = 2,  type = "text", style = "default", title = "lum_s Mixed models (Estimate + (Std. Error)", column.labels = c("Flanges", "Maxilla", "Mandible", "Palate"))
```
...
lum_s.sum <- stargazer(mr4.side, mr4.maxi, mr4.mand, mr4.pala, digits = 2,  type = "text", style = "default", title = "lum_s Mixed models (Estimate + (Std. Error)", column.labels = c("Flanges", "Maxilla", "Mandible", "Palate"))
```
...
```{r}
mr5.side.sex <- lmer(S9_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.side)
mr5.maxi.sex <- lmer(S9_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.maxi)
mr5.mand.sex <- lmer(S9_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.mand)
mr5.pala.sex <- lmer(S9_s ~ (Type * Age) + Sex + (1|Individual) + (1|Nestbox), data = TCS_DB_data.pala)

class(mr5.side.sex) <- "lmerMod"
class(mr5.maxi.sex) <- "lmerMod"
class(mr5.mand.sex) <- "lmerMod"
class(mr5.pala.sex) <- "lmerMod"

S9_s.sum.sex <- stargazer(mr5.side.sex, mr5.maxi.sex, mr5.mand.sex,  mr5.pala.sex, type = "text", style = "default", title = "S9_s Mixed models (Estimate + (Std. Error)", column.labels = c("Side", "Maxilla", "Mandible", "Palate"))
```
